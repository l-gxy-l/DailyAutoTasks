...
echo [%date% %time%] ---------------- 前置任务已完成 ------------------------- >> "%mainlog%"

echo [%date% %time%] ================ 3. 配置 logman 采集器 ================== >> "%mainlog%"
